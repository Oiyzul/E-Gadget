...
const ProductItem = ({ product }: { product: TProduct }) => {
  const { _id, name, images, model, features, price, rating , discount} = product;
  
  return (
    <div key={`product-item-${_id}`} className="max-w-sm mx-auto bg-gray-900 text-white rounded-lg">
