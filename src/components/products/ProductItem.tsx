  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-lg shadow-lg group">
        <div 
        className="relative w-full sm:w-full h-[36vh] sm:h-[30vh] md:max-h-[20vh] lg:h-[36vh]"
        >
          <Image
            src={images[0]}
            alt="Card Image"
        ...
        <div className="flex flex-col items-center p-4">
          <h3 className="text-center text-lg font-semibold">{name.substring(0,20)}</h3>
          <p>Model: {model}</p>
          <p>Price: {price} BDT</p>
        ...
        <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out">
          <h3 className="text-white text-lg font-semibold mb-2">{name.substring(0,25)}</h3>
