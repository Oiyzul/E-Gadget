...
export async function POST(request: NextRequest) {
  ...
  try {
    const response = await axios.post(process.env.PAYMENT_URL as string, {
      ...
      success_url: `https://egadgetbd.vercel.app/api/payment/confirmation?orderId=${order}&transactionId=${transactionId}&status=success`,
      fail_url: `https://egadgetbd.vercel.app/api/payment/confirmation?status=fail`,
      cancel_url: `https://egadgetbd.vercel.app/`,
      currency: "BDT",
      amount: totalPrice,
